...
class Emoney extends BaseController
{
	...
	public function index()
	{
		...
		$param['title'] = "Data Produk E-Money";
		$param['content'] = "emoney";

		$RetrieveProduk = $EmoneyModel->viewproduk();
	...
	public function add()
	{
		...
		$RetrieveProduk = $EmoneyModel->viewproduk($param['CODE']);
	...
	public function updaterow()
    {
		...
		$RetrieveProduk = $EmoneyModel->viewproduk($IN_CODE);
        ...
        $Retrieve = $EmoneyModel->update($ID ,$param);
