...
class Voucher extends BaseController
{
	...
	public function index()
	{
		...
		$param['title'] = "Data Produk Voucher";
		$param['content'] = "voucher";

		$RetrieveProduk = $VoucherModel->viewproduk();
	...
	public function add()
	{
		...
		$RetrieveProduk = $VoucherModel->viewproduk($param['CODE']);
	...
	public function updaterow()
    {
		...
		$RetrieveProduk = $VoucherModel->viewproduk($IN_CODE);
        ...
        $Retrieve = $VoucherModel->update($ID ,$param);
