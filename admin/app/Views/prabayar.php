...
$paramadd = array();
$paramadd['provider'] = $DataProvider;
$SendAdd = base64_encode(json_encode($paramadd));

$TIPE = array("PULSA","DATA","PLN","PAKET NELPON","PAKET SMS");

?>
<div class="row">
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
		<button class="btn btn-info" onclick="modal('modal-xl', 'Tambah Produk', 'modal_prabayar_multiple', '<?php echo $SendAdd; ?>', 'prabayar/add')">
...
<div class="collapse padtop-20" id="formUpload">
	<div class="row">
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
			<div class="card">
				<div class="card-body">
					<form id="formImport" name="formImport" action="<?php echo base_url('import/prabayar') ?>" method="post" enctype="multipart/form-data">
			...
			<table class="table table-bordered table-pulsa">
				...
				<tbody>
					...
					foreach($DataTable as $row){
						...
						$paramupdate['provider'] = $DataProvider;
						...
						<tr>
							...
							<td style="text-align: center;">
								...
								<a href="javascript:void(0)" title="Update Info" style="text-decoration: none;">
									<button class="btn btn-primary" onclick="modal('modal-md', 'Edit Data Produk', 'modal_prabayar', '<?php echo $SendEdit; ?>', 'prabayar/updaterow')">
