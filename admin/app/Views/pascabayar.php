...
<div class="row">
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
		<button class="btn btn-info" onclick="modal('modal-md', 'Tambah Produk', 'modal_pascabayar', '<?php echo $SendAdd; ?>', 'pascabayar/add')">
...
<div class="collapse padtop-20" id="formUpload">
	<div class="row">
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
			<div class="card">
				<div class="card-body">
					<form id="formImport" name="formImport" action="<?php echo base_url('import/pascabayar') ?>" method="post" enctype="multipart/form-data">
						...
						<tr>
							...
							<td style="text-align: center;">
								...
								<a href="javascript:void(0)" title="Update Info" style="text-decoration: none;">
									<button class="btn btn-primary" onclick="modal('modal-md', 'Edit Data Produk', 'modal_pascabayar', '<?php echo $SendEdit; ?>', 'pascabayar/updaterow')">
