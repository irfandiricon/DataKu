...
<div class="row">
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
		...
		<input type="hidden" name="number" value="<?php echo $ID_PELANGGAN ?>">
	</div>
</div>
...
<div class="row">
	...
	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
		<label><?php echo str_replace("|", " | ", $ID_PELANGGAN); ?></label>
	</div>
</div>
...
<script type="text/javascript">
	$(function(){
		$('button#submit').on('click', function(e){
			e.preventDefault();
			modal('modal-md', 'PIN Transaksi', 'games/modal_pin', '<?php echo base64_encode(json_encode($rows)) ?>', 'games/proses', '<?php echo base_url() ?>');
		});
	});
</script>
