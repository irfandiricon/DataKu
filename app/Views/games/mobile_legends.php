...
<form action="javascript:void(0)" method="post" id="formData" data-proses="<?php echo base_url() ?>">
	<div class="row padbottom-20" style="padding-top: 30px;">
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 padtop-10 padleft-0 padright-0">
		    ...
		    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
		    	 <input type="text" name="serverid" id="serverid" placeholder="Masukan Server ID" class="form-control" onkeypress="return hanyaAngka(event)" maxlength="4">
		    </div>
		</div>
...
<script type="text/javascript">
	function viewprice()
	{
		...
		$.ajax({
			url : url+'/games/view_price/mobile_legends',
			data : data,
			cache : false,
			type : 'post',
			beforeSend : function(){
