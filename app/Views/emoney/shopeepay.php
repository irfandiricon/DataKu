			...
			<div class="row" style="padding-top: 30px;">
			    ...
			    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			        <div class="input-group mb-3">
			            <input type="number" name="phone_number" id="phone_number" placeholder="Masukan Nomor Tujuan" class="form-control" style="border-right: 0;" onkeypress="return hanyaAngka(event)">
			            <div class="input-group-append" style="cursor: pointer; background-color: #17a2b8; color: white;">
...
<script type="text/javascript">
	function viewprice()
	{
		...
		$.ajax({
			url : url+'/emoney/view_price/shopeepay',
			data : data,
			cache : false,
			type : 'post',
			beforeSend : function(){
