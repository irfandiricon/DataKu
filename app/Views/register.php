<form id="formData" name="formData" action="javascript:void(0)" data-url="<?php echo base_url('register/pregister')?>">
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row padtop-10">
						...
						<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
							<button class="btn btn-primary" type="button" onclick="submitform()">Daftar Sekarang</button>&nbsp;
