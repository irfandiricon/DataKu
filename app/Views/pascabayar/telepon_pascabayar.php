...
<div class="card">
    <div class="card-body">
		...
		<form action="javascript:void(0)" method="post" data-url="<?php echo base_url('pascabayar/proses/telepon') ?>" id="formData" data-proses="<?php echo base_url() ?>">
...
<script type="text/javascript">
	...
	function viewprice()
	{
		...
		$.ajax({
			url : url+'/pascabayar/view_price/telepon',
			data : data,
			cache : false,
			type : 'post',
			beforeSend : function(){
