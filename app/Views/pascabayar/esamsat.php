...
<div class="card">
    <div class="card-body">
		...
		<form action="javascript:void(0)" method="post" data-url="<?php echo base_url('pascabayar/proses/esamsat') ?>" id="formData" data-proses="<?php echo base_url() ?>">
			<div class="row padbottom-20" style="padding-top: 30px;">
				...
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 padtop-10 padleft-0 padright-0">
				    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				        <h5>Nomor Indentitas (KTP)</h5>
				    </div>
				    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				    	 <input type="number" name="nomor_identitas" id="nomor_identitas" placeholder="Masukan Nomor Identitas" class="form-control" onkeypress="return hanyaAngka(event)">
				    </div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 padtop-10 padleft-0 padright-0"></div>
...
<script type="text/javascript">
	...
	function viewprice()
	{
		...
		$.ajax({
			url : url+'/pascabayar/view_price/esamsat',
			data : data,
			cache : false,
			type : 'post',
			beforeSend : function(){
