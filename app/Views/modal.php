...
<div class="modal-dialog <?php echo $MODAL?>" role="document">
	<div class="modal-content">
		<form method="post" action="javascript:void(0)" data-url="<?php echo $actionform ?>" id="formDataModal" name="formDataModal">
			...
			<div class="modal-footer">
				...
				if(!empty($ACTION)){
				?>
					<button type="button" class="btn btn-info" id="submit" onclick="submitformmodal()">Save</button>
				<?php } ?>
